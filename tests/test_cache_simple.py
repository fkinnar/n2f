...
from core import get_from_cache, set_in_cache, invalidate_cache_key, clear_cache, make_cache_key
...
class TestCacheSimple(unittest.TestCase):
    ...
    def test_make_cache_key_with_parameters(self):
        ...
        key = make_cache_key("get_users", "scope1", 100, True)
    ...
    def test_make_cache_key_with_mixed_types(self):
        ...
        key = make_cache_key("get_data", "string", 42, True, None, [1, 2, 3])
    ...
    def test_set_in_cache_and_get(self):
        ...
        set_in_cache(self.df1, "get_users")
    ...
    def test_set_in_cache_with_parameters_and_get(self):
        ...
        set_in_cache(self.df1, "get_users", "scope1", 100)
    ...
    def test_get_from_cache_returns_copy(self):
        ...
        # Récupérer deux fois
        result1 = get_from_cache("get_users")
        result2 = get_from_cache("get_users")
    ...
    def test_cache_isolation_different_keys(self):
        ...
        set_in_cache(self.df1, "get_users")
        set_in_cache(self.df2, "get_companies")

        # Récupérer et vérifier l'isolation
        users = get_from_cache("get_users")
        companies = get_from_cache("get_companies")
    ...
    def test_cache_isolation_different_parameters(self):
        ...
        set_in_cache(self.df1, "get_users", "scope1")
        set_in_cache(self.df2, "get_users", "scope2")

        # Récupérer et vérifier l'isolation
        scope1_data = get_from_cache("get_users", "scope1")
        scope2_data = get_from_cache("get_users", "scope2")
    ...
    def test_invalidate_cache_key_existing(self):
        ...
        # Invalider la clé
        invalidate_cache_key("get_users")
    ...
    def test_invalidate_cache_key_with_parameters(self):
        ...
        set_in_cache(self.df1, "get_users", "scope1", 100)
        set_in_cache(self.df2, "get_users", "scope2", 200)

        # Invalider une clé spécifique
        invalidate_cache_key("get_users", "scope1", 100)

        # Vérifier que seule la clé spécifique a été invalidée
        result1 = get_from_cache("get_users", "scope1", 100)
        result2 = get_from_cache("get_users", "scope2", 200)
    ...
    def test_invalidate_cache_key_nonexistent(self):
        ...
        invalidate_cache_key("nonexistent_function")
    ...
    def test_clear_cache_with_data(self):
        ...
        set_in_cache(self.df1, "get_users")
        set_in_cache(self.df2, "get_companies")
        set_in_cache(self.df_empty, "get_projects", "scope1")

        # Vérifier que les données sont dans le cache
        self.assertIsNotNone(get_from_cache("get_users"))
        self.assertIsNotNone(get_from_cache("get_companies"))
        self.assertIsNotNone(get_from_cache("get_projects", "scope1"))

        # Nettoyer le cache
        clear_cache()

        # Vérifier que tout a été supprimé
        self.assertIsNone(get_from_cache("get_users"))
        self.assertIsNone(get_from_cache("get_companies"))
        self.assertIsNone(get_from_cache("get_projects", "scope1"))

    def test_cache_with_empty_dataframe(self):
        """Test de cache avec un DataFrame vide."""
        # Stocker un DataFrame vide
        set_in_cache(self.df_empty, "get_empty")

        # Récupérer et vérifier
        result = get_from_cache("get_empty")
    ...
    def test_cache_overwrite_existing_key(self):
        ...
        set_in_cache(self.df2, "get_users")
