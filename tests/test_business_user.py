...
class TestBusinessUser(unittest.TestCase):
    ...
    def test_load_n2f_data_success(self, mock_build_mapping, mock_normalize):
        ...
        # Exécution de la fonction
        result_users, result_companies = user_process._load_n2f_data(
    ...
    def test_synchronize_create_only(
        self, mock_reporting, mock_synchronizer_class, mock_load_agresso, mock_load_n2f
    ):
        ...
        mock_synchronizer.create_entities.return_value = (
    ...
    def test_synchronize_update_only(
        ...
        mock_synchronizer = Mock()
        mock_synchronizer_class.return_value = mock_synchronizer
        mock_synchronizer.update_entities.return_value = (
            self.df_agresso_users,
            "updated",
        )
    ...
    def test_synchronize_delete_only(
        ...
        mock_synchronizer = Mock()
        mock_synchronizer_class.return_value = mock_synchronizer
        mock_synchronizer.delete_entities.return_value = (
            self.df_agresso_users,
            "deleted",
        )
    ...
    @patch("business.process.user.UserSynchronizer")
    @patch("business.process.user.reporting")
    def test_synchronize_empty_results(
        self, mock_reporting, mock_synchronizer_class, mock_load_agresso, mock_load_n2f
    ):
    ...
    @patch("business.process.user.UserSynchronizer")
    @patch("business.process.user.reporting")
    def test_synchronize_with_sql_column_filter(
        self, mock_reporting, mock_synchronizer_class, mock_load_agresso, mock_load_n2f
    ):
