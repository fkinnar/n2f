...
cache:
  ...
  max_size: 100
    ...
    def test_run_with_specific_scopes(self, mock_retry_summary, mock_metrics_summary,
                                    mock_memory_summary, mock_cache_stats, mock_cleanup_all,
                                    mock_cleanup_scope, mock_end_operation, mock_start_operation,
                                    mock_executor, mock_context, mock_registry, mock_config_loader):
    ...
    @patch('core.orchestrator.cleanup_all')
    @patch('core.orchestrator.print_memory_summary')
    def test_run_with_scope_execution_error(self, mock_print_memory_summary, mock_cleanup_all, mock_cleanup_scope,
                                          mock_end_operation, mock_start_operation,
                                          mock_executor, mock_context, mock_registry,
                                          mock_config_loader):
        ...
        mock_executor_instance.execute_scope.side_effect = Exception("Scope execution error")
