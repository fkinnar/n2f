"""
Tests unitaires pour le module python/n2f/process/user.py.
...
from n2f.process.user import (
    lookup_company_id, build_user_payload, ensure_manager_exists,
...
class TestBuildUserPayload(unittest.TestCase):
    ...
    def test_build_user_payload_with_manager_email(self):
        ...
        with patch('n2f.process.user.create_user_upsert_payload') as mock_create_payload:
            ...
            result = build_user_payload(
                ...
                self.mock_client, self.df_n2f_companies, True,
...
class TestEnsureManagerExists(unittest.TestCase):
    ...
    def test_ensure_manager_exists_already_in_n2f(self):
        ...
        result = ensure_manager_exists(
            'manager@test.com', self.df_agresso_users, self.df_n2f_users,
            self.mock_client, self.df_n2f_companies, True
        )
    ...
    def test_ensure_manager_exists_in_agresso_but_not_n2f(self):
        ...
        with patch('n2f.process.user.build_user_payload') as mock_build_payload:
            ...
            mock_result = ApiResult.success_result("Created", "manager@test.com", "create", "user", "manager@test.com", "users")
    ...
    def test_ensure_manager_exists_not_found_anywhere(self):
        ...
        result = ensure_manager_exists(
            'unknown@test.com', self.df_agresso_users, self.df_n2f_users,
            self.mock_client, self.df_n2f_companies, True
        )
        self.assertEqual(result, '')
    ...
    def test_ensure_manager_exists_circular_reference(self):
        ...
        df_agresso_circular = pd.DataFrame({
            ...
            'Prenom': ['First1', 'First'],
            'Entreprise': ['COMP1', 'COMP1'],
            'Manager': ['manager@test.com', 'user1@test.com'],  # Référence circulaire
            'Role': ['User', 'Manager']
        })
        ...
        with patch('n2f.process.user.build_user_payload') as mock_build_payload:
            ...
            result = ensure_manager_exists(
                'manager@test.com', df_agresso_circular, self.df_n2f_users,
                self.mock_client, self.df_n2f_companies, True
            )
...
class TestCreateUsers(unittest.TestCase):
    ...
    def test_create_users_empty_agresso_users(self):
        ...
        result_df, status_col = create_users(
            empty_df, self.df_n2f_users, self.df_n2f_companies,
    ...
    def test_create_users_all_users_exist(self):
        ...
        result_df, status_col = create_users(
            self.df_agresso_users, df_n2f_all_users, self.df_n2f_companies,
            self.mock_client, True
        )
    ...
    def test_create_users_success(self):
        ...
        with patch('n2f.process.user.build_user_payload') as mock_build_payload:
            ...
            mock_result = ApiResult.success_result("Created", "user2@test.com", "create", "user", "user2@test.com", "users")
            self.mock_client.create_user.return_value = mock_result
            
            result_df, status_col = create_users(
                self.df_agresso_users, self.df_n2f_users, self.df_n2f_companies,
                self.mock_client, True
            )
...
class TestUpdateUsers(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.df_n2f_users = pd.DataFrame({
            'mail': ['user1@test.com', 'user2@test.com'],
            'name': ['User1', 'User2']
        })
        self.df_n2f_companies = pd.DataFrame({
            'code': ['COMP1', 'COMP2'],
    ...
    def test_update_users_empty_n2f_users(self):
        ...
        empty_df = pd.DataFrame()
        result_df, status_col = update_users(
            self.df_agresso_users, empty_df, self.df_n2f_companies,
            self.mock_client, True
        )
    ...
    def test_update_users_success(self):
        ...
        with patch('n2f.process.user.has_payload_changes') as mock_has_changes:
            ...
            with patch('n2f.process.user.build_user_payload') as mock_build_payload:
                ...
                mock_result = ApiResult.success_result("Updated", "user1@test.com", "update", "user", "user1@test.com", "users")
...
class TestDeleteUsers(unittest.TestCase):
    ...
    def test_delete_users_success(self):
        ...
        mock_result = ApiResult.success_result("Deleted", "user2@test.com", "delete", "user", "user2@test.com", "users")
