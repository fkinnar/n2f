...
class TestUserApi(unittest.TestCase):
    ...
    def test_get_users_success(self, mock_retreive: Mock) -> None:
        ...
        mock_retreive.assert_called_once_with(
            "users", self.base_url, self.client_id, self.client_secret, 0, 200, False
        )
    ...
    def test_get_users_with_pagination(self, mock_retreive: Mock) -> None:
        ...
        user_api.get_users(
            self.base_url, self.client_id, self.client_secret, start=50, limit=100
        )

        mock_retreive.assert_called_once_with(
            "users", self.base_url, self.client_id, self.client_secret, 50, 100, False
        )
    ...
    def test_get_users_simulation_mode(self, mock_retreive: Mock) -> None:
        ...
        mock_retreive.assert_called_once_with(
            "users", self.base_url, self.client_id, self.client_secret, 0, 200, True
        )
...
class TestCompanyApi(unittest.TestCase):
    ...
    def test_get_companies_with_pagination(self, mock_retreive: Mock) -> None:
        ...
        company_api.get_companies(
            self.base_url, self.client_id, self.client_secret, start=25, limit=50
        )
    ...
    def test_get_companies_simulation_mode(self, mock_retreive: Mock) -> None:
        ...
        mock_retreive.assert_called_once_with(
            "companies", self.base_url, self.client_id, self.client_secret, 0, 200, True
        )
...
class TestCustomAxeApi(unittest.TestCase):
    ...
    def test_get_customaxes_values_success(self, mock_get_session, mock_get_token):
        ...
        result = customaxe_api.get_customaxes_values(
            self.base_url,
            self.client_id,
            self.client_secret,
            self.company_id,
    ...
    @patch("n2f.api.customaxe.get_access_token")
    @patch("n2f.get_session_get")
    def test_get_customaxes_values_simulation_mode(
        self, mock_get_session, mock_get_token
    ):
    ...
    def test_get_customaxes_values_http_error(self, mock_get_session, mock_get_token):
        ...
        with self.assertRaises(Exception):
            customaxe_api.get_customaxes_values(
                self.base_url,
                self.client_id,
                self.client_secret,
                self.company_id,
...
class TestProjectApi(unittest.TestCase):
    ...
    def test_get_projects_success(self, mock_get_customaxes_values):
        ...
        result = project_api.get_projects(
            self.base_url, self.client_id, self.client_secret, self.company_id, 0, 100
        )
    ...
    def test_get_projects_with_pagination(self, mock_get_customaxes_values):
        ...
        project_api.get_projects(
            self.base_url, self.client_id, self.client_secret, self.company_id, 10, 50
        )
    ...
    def test_create_project_success(self, mock_upsert):
        ...
        mock_upsert.assert_called_once_with(
            self.base_url,
            f"/companies/{self.company_id}/axes/projects",
            self.client_id,
            self.client_secret,
            self.payload,
            False,
    ...
    def test_update_project_success(self, mock_upsert):
        ...
        result = project_api.update_project(
            self.base_url,
            self.client_id,
            self.client_secret,
            self.company_id,
    ...
    def test_delete_project_success(self, mock_delete):
        ...
        result = project_api.delete_project(
            self.base_url,
            self.client_id,
            self.client_secret,
            self.company_id,
