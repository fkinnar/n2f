...
class ApiResult:
    ...
    def success_result(cls, message: str = "Success", status_code: int = 200, 
                      duration_ms: Optional[float] = None, response_data: Optional[Any] = None) -> 'ApiResult':
    ...
    def error_result(cls, message: str, status_code: Optional[int] = None, 
                    duration_ms: Optional[float] = None, error_details: Optional[str] = None) -> 'ApiResult':
    ...
    @classmethod
    def simulate_result(cls, operation: str) -> 'ApiResult':
